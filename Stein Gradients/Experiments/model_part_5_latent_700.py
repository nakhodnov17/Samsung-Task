...
checkpoint_file_name_2 = './Checkpoints/' + own_name + '.pth'
plots_file_name_2 = './Plots/' + own_name + '.png'
log_file_name_2 = './Logs/' + own_name + '.txt'
